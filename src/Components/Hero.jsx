        ...
        <div className=" container relative" ref={parallaxRef}>
            <div className=" relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
                <h1 className=" h1 mb-6">
                    ...
                    <span className=" inline-block relative">
                        ...
                        width={624} height={24} alt="curve" />
                    </span>
                </h1>
                <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
                    Unleash the power of AI within Brainwave. Upgrade your productivity with Brainwave, the openAI chat app.
                </p>
            ...
            <div className=" relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
                    ...
                    <div className=" relative bg-n-8 rounded-[1rem]">
                        ...
                        lg:aspect-[1024/490] ">
                            ...
                            <ScrollParallax isAbsolutelyPositioned>
                                ...
                                bg-n-9/40 blackdrop-blur border border-n-1/10 rounded-2xl xl:flex">
                ...
                md:-top-[46%] md:w-[138%] lg:-top-[104%] ">
                    ...
                    className="w-full" width={1440} height={1800} alt="hero"/>
                </div>
