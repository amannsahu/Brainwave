        ...
        <div className=" container lg:flex">
            <div className=" max-w-[25rem]">
                <h2 className=" h2 mb-4 md:mb-8">
                    AI Chat App for seamless collaboeation
                </h2>
            ...
            <div className=" lg:ml-auto xl:w-[38rem]">
                <p className="body-2 mb-10 mt-4 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto">
                    {collabText}
                </p>
                        ...
                        {collabApps.map((app, index) => (
                            ...
                            rotate-${index * 45}`}>
                                <div className={` relative -top-[1.6rem] flex w-[3.2rem] h-[3.2rem] bg-n-7
                                    ...
                                    <img className="m-auto" width={app.width} height={app.height}
                                    alt={app.title}
                                    src={app.icon} />
                                </div>
                            </li>
