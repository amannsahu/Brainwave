...
import { check, service2, service3 } from '../../public/assets'
import {PhotChatMessage, VideoChatMessage, Gradient, VideoBar} from "../Section/design/Services"
        ...
        <div className='container'>
            ...
            <div className='relative'>
                ...
                lg:p-20 xl:h-[46rem]'>
                    ...
                    <Generating 
                    className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg:bottom-8 lg:-translate-x-1/2"
                    />
                </div>
                        ...
                        <div className='py-12 px-4 xl:px-8'>
                            ...
                            <ul className='flex items-center justify-between'>
                                {brainwaveServicesIcons.map((item, index) => (
                                    <li key={index} className={`rounded-2xl flex items-center justify-center hover:scale-125 transition-all duration-300 cursor-pointer ${index === 2 ? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]' : 'flex w-10 h-10 bg-n-6 md:w-15 md:h-15'}`}>
